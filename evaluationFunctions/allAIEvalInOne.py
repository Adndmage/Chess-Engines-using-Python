...
model_board_eval_file_path = os.path.join(current_dir, "AI_stuff", "simpelModel.pth")

def evaluate_board_eval(board):
    """
    ...
    model.load_state_dict(torch.load(model_board_eval_file_path))
...
model_board_10_10_10_eval_file_path = os.path.join(current_dir, "AI_stuff", "biggerModel.pth")

def evaluate_board_10_10_10_eval(board):
    """
    Evaluate a chess board using the trained model.
    :param board: A chess.Board object.
    :return: The evaluation score predicted by the model.
    ...
    model.load_state_dict(torch.load(model_board_10_10_10_eval_file_path))
    model.eval()  # Set the model to evaluation mode
...
model_board_64_32_16_eval_file_path = os.path.join(current_dir, "AI_stuff", "biggestModel.pth")

def evaluate_board_64_32_16_eval(board):
    """
    Evaluate a chess board using the trained model.
    :param board: A chess.Board object.
    :return: The evaluation score predicted by the model.
    """
    # Load the trained model
    model = BiggestChessNet()
    model.load_state_dict(torch.load(model_board_64_32_16_eval_file_path))
    model.eval()  # Set the model to evaluation mode
...
model_board_128_64_32_16_eval_file_path = os.path.join(current_dir, "AI_stuff", "biggerThanBiggestModel.pth")

def evaluate_board_128_64_32_16_eval(board):
    """
    Evaluate a chess board using the trained model.
    :param board: A chess.Board object.
    :return: The evaluation score predicted by the model.
    ...
    model.load_state_dict(torch.load(model_board_128_64_32_16_eval_file_path))
    model.eval()  # Set the model to evaluation mode
...
model_board_64_64_32_32_16_16_eval_file_path = os.path.join(current_dir, "AI_stuff", "longerThanBiggestModel.pth")

def evaluate_board_64_64_32_32_16_16_eval(board):
    """
    Evaluate a chess board using the trained model.
    :param board: A chess.Board object.
    :return: The evaluation score predicted by the model.
    """
    # Load the trained model
    model = LongerThanBiggestChessNet()
    model.load_state_dict(torch.load(model_board_64_64_32_32_16_16_eval_file_path))
    model.eval()  # Set the model to evaluation mode
...
model_newdata_board_128_64_32_16_eval_file_path = os.path.join(current_dir, "AI_stuff", "newBiggerThanBiggestModel.pth")

def evaluate_newdata_board_128_64_32_16_eval(board):
    """
    Evaluate a chess board using the trained model.
    :param board: A chess.Board object.
    :return: The evaluation score predicted by the model.
    ...
    # Load the trained model
    model = BiggerThanBiggestChessNet()
    model.load_state_dict(torch.load(model_newdata_board_128_64_32_16_eval_file_path))
    model.eval()  # Set the model to evaluation mode
...
model_newdata_board2_128_64_32_16_eval_file_path = os.path.join(current_dir, "AI_stuff", "newNewTensorBiggerThanBiggestModel.pth")

def evaluate_newdata_board2_128_64_32_16_eval(board):
    """
    Evaluate a chess board using the trained model.
    :param board: A chess.Board object.
    :return: The evaluation score predicted by the model.
    ...
    model.load_state_dict(torch.load(model_newdata_board2_128_64_32_16_eval_file_path))
    model.eval()  # Set the model to evaluation mode
...
if __name__ == "__main__":
    ...
    # Evaluate the board
    print(f"Board Evaluation: {evaluate_board_eval(board):.6f}, {evaluate_board_10_10_10_eval(board):.6f}, {evaluate_board_64_32_16_eval(board):.6f}, {evaluate_board_128_64_32_16_eval(board):.6f}, {evaluate_board_64_64_32_32_16_16_eval(board):.6f}, {evaluate_board_128_64_32_16_eval(board):.6f}, {evaluate_newdata_board2_128_64_32_16_eval(board):.6f}")